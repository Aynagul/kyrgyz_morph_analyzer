...
def cases_pronoun_root(root):
    if root in sourceModule.prn_gen:
        ...
        return 'abl'
    elif root in sourceModule.prn_xp:
        return 'xp'
...
personal_pronoun = {'мен','сен','сиз','ал','биз','силер','сиздер','алар',
        'менин','сенин','анын',
    'мага','сага','ага', 'мени','сени','аны', 'анда', 'андан', 'меники','аныкы','сеники'
                     }
...
Personal_pronoun_first_person ={'мен','биз', 'менин', 'мага', 'мени', 'меники'
}
Personal_pronoun_second_person = {'сен','сиз','силер','сиздер', 'сенин', 'сага', 'сени','сеники'
}
Personal_pronoun_third_person = {'ал','алар', 'анын', 'ага', 'аны', 'анда', 'андан','аныкы'
}
